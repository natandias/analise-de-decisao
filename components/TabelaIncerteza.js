                ...
                <div className="py-2 inline-block min-w-full sm:px-6 lg:px-8">
                  <div className="overflow-hidden">
                      ...
                      <tbody>
                        ...
                        {investimentos.map((field, fieldIndex) => (
                          ...
                          >
                            ...
                            <td
                              className={`${
                                fieldIndex === bestMaxiMax && "font-bold"
                            ...
                            <td
                              className={`${
                                fieldIndex === bestMaxiMin && "font-bold"
                              } text-center text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap`}
                            >
                            ...
                            <td
                              className={`${
                                fieldIndex === bestLaplace && "font-bold"
                              } text-center text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap`}
                            >
                            ...
                            <td
                              className={`${
                                fieldIndex === bestHurwicz && "font-bold"
                              } text-center text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap`}
                            >
                    ...
                    <p className="text-md text-center mt-6">
                      <strong>MaxiMax:</strong> Investimento {bestMaxiMax + 1}
                    </p>

                    <p className="text-md text-center mt-2">
                      <strong>MaxiMin:</strong> Investimento {bestMaxiMin + 1}
                    </p>

                    <p className="text-md text-center mt-2">
                      <strong>Laplace:</strong> Investimento {bestLaplace + 1}
                    </p>

                    <p className="text-md text-center mt-2">
                      <strong>Hurwicz:</strong> Investimento {bestHurwicz + 1}
                    </p>
                  </div>
                </div>
              </div>
